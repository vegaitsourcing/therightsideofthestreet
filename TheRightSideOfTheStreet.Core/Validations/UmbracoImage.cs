...
namespace TheRightSideOfTheStreet.Core.Validations
{
	...
	public class MultipleImagesExtensionsAttribute : ValidationAttribute, IClientValidatable
	{
		...
		public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
		{
			...
			{
				ErrorMessage = error,
				ValidationType = metadata.ModelType.Equals(typeof(HttpPostedFileBase)) ? "imagevalid" : "multipleimagevalid"
			};
	...
	public class ListFileSizeAttribute : ValidationAttribute, IClientValidatable
	{
		...
		public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
		{
			...
			{
				ErrorMessage = error,
				ValidationType = metadata.ModelType.Equals(typeof(HttpPostedFileBase)) ? "filesize" : "multiplefilesize"
			};
